...
class Minesweeper:
    ...
    def start_game(self):
        # Кыйынчылык деңгээлине жараша параметрлер
    ...
    def show_export_window(self):
        ...
        export_window.geometry("450x550")
    ...
    def get_export_data(self, export_type):
        if export_type == "Standard":
            return [["Game", "Mines", "Flags", "Status"],
                    ["Sapper", self.mines, self.game.flags_placed, "Win" if self.game.game_over else "Playing"]]
            ...
            return [["Player", self.player_name], ["Difficulty", self.difficulty],
                    ["Mines", self.mines], ["Flags Placed", self.game.flags_placed],
