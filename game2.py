...
class ModernSaper:
    ...
    def menu_screen(self):
        ...
        title = ctk.CTkLabel(frame, text="MINESWEEPER",
                             font=("Arial", 40, "bold"))
        title.pack(pady=30)

        btn = ctk.CTkButton(frame, text="START GAME",
                            command=self.ask_nickname)
        btn.pack(pady=10)
